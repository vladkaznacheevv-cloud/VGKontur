...
- Требует действий вне кода до боевого запуска: боевые Telegram-креды (только в окружении деплоя); проверить необходимость уведомления Роскомнадзора / включения в реестр операторов ПДн перед масштабным рекламным трафиком.
